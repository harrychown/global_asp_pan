...
output_filename <- "/Users/user/Documents/manchester/tr/figures/total_TR_count.pdf"
pdf(file=output_filename,width = 12, height = 19)
print(total_tr_P)
dev.off()
...
total_tr_G_P <- ggplot(total_tr_count, aes(x=Freq, y=Genotype, fill=Genotype)) + 
  ...
  theme(panel.background = element_blank(),
        ...
        text = element_text(size = 14, colour = "black"),
        legend.position="none") 
output_filename <- "/Users/user/Documents/manchester/tr/figures/total_TR_count-genotype.pdf"
pdf(file=output_filename,width = 10, height = 20)
print(total_tr_G_P)
dev.off()
...
output_filename <- "/Users/user/Documents/manchester/tr/figures/average_repeat_length.pdf"
pdf(file=output_filename,width = 12, height = 6)
...
average_num_rep_P <- ggplot(average_num_rep_df, aes(x=Cluster, y=Mean, fill=Cluster)) + 
  ...
  theme(panel.background = element_blank(),
        ...
        text = element_text(size = 14, colour = "black"),
        legend.position="none") 
output_filename <- "/Users/user/Documents/manchester/tr/figures/average_number_of_repeats.pdf"
pdf(file=output_filename,width = 12, height = 6)
...
output_filename <- "/Users/user/Documents/manchester/tr/figures/average_unit_size.pdf"
pdf(file=output_filename,width = 12, height = 6)
...
output_filename <- "/Users/user/Documents/manchester/tr/figures/count_by_size_category.pdf"
pdf(file=output_filename,width = 10, height = 15)
...
output_filename <- "/Users/user/Documents/manchester/tr/figures/count_by_length_category.pdf"
pdf(file=output_filename,width = 10, height = 15)
